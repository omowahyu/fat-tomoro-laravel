...
return [
    ...
    */
    ...
    // Use a relative URL by default so it follows current host/port
    'back_to_system_url' => env('LOG_VIEWER_BACK_TO_URL', '/'),
    ...
    */
    ...
    // Use application timezone; fallback to env APP_TIMEZONE if provided
